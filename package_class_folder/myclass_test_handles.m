...
assert(isequal(hn(mypkg.myclass.m, mypkg.myclass.m2), mypkg.myclass.m2));
...
assert(isequal(hn(mypkg.myclass.m, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.m, mypkg.myclass.s2o), mypkg.myclass.s2));
...
assert(isequal(hn(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hn(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hn(mypkg.myclass.m, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.m2), mypkg.myclass.m2));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.m), mypkg.myclass.m));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.s2o), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hn(mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hn(mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hn(mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.s2o), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.l), mypkg.myclass.l));
assert(isequal(hn(mypkg.myclass.l, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hn(mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hn(mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hn(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hn(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hn(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hm(obj, mypkg.myclass.m2), mypkg.myclass.m2));
assert(isequal(hm(obj, mypkg.myclass.m2, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm(obj, mypkg.myclass.m2, mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hm(obj, mypkg.myclass.m2, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm(obj, mypkg.myclass.m2, mypkg.myclass.s2o), mypkg.myclass.s2));
assert(isequal(hm(obj, mypkg.myclass.m2, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm(obj, mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm(obj, mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm(obj, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm(obj, mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hm(obj, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm(obj, mypkg.myclass.s2o), mypkg.myclass.s2));
...
assert(isequal(hm(obj, mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hm(obj, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hm(obj, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hmo(mypkg.myclass.m2), mypkg.myclass.m2));
assert(isequal(hmo(mypkg.myclass.m2, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hmo(mypkg.myclass.m2, mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hmo(mypkg.myclass.m2, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hmo(mypkg.myclass.m2, mypkg.myclass.s2o), mypkg.myclass.s2));
assert(isequal(hmo(mypkg.myclass.m2, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hmo(mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hmo(mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hmo(mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hmo(mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hmo(mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hmo(mypkg.myclass.s2o), mypkg.myclass.s2));
assert(isequal(hmo(mypkg.myclass.l), mypkg.myclass.l));
assert(isequal(hmo(mypkg.myclass.l, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hmo(mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hmo(mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hmo(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hmo(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hmo(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hmvo(mypkg.myclass.m2, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hmvo(mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hmvo(mypkg.myclass.m2, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hmvo(mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hmvo(mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hmvo(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hmvo(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hmvo(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.l), mypkg.myclass.l));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2(obj, mypkg.myclass.m, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hm2(obj, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2(obj, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2(obj, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
hm2o = obj.call(mypkg.myclass.hm2o);
assert(isequal(hm2o(), mypkg.myclass.m2));
assert(isequal(hm2o(mypkg.myclass.m), mypkg.myclass.m));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.s2o), mypkg.myclass.s2));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.l), mypkg.myclass.l));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.m, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2o(mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.so), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2o(mypkg.myclass.s2o), mypkg.myclass.s2));
assert(isequal(hm2o(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2o(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2o(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.l), mypkg.myclass.l));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2vo(mypkg.myclass.m, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hm2vo(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hm2vo(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hm2vo(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hs(mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hs(mypkg.myclass.l), mypkg.myclass.l));
assert(isequal(hs(mypkg.myclass.l, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs(mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hs(mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hs(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hs(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hsv(mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hsv(mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hsv(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hsv(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hsv(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hso(mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hso(mypkg.myclass.l), mypkg.myclass.l));
assert(isequal(hso(mypkg.myclass.l, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hso(mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hso(mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hso(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hso(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hso(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hsvo(mypkg.myclass.l, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hsvo(mypkg.myclass.l, mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hsvo(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hsvo(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hsvo(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));

% hs2, hs2->s, hs2->p, hs2->p->s, hs2->p->s2
hs2 = obj.call(mypkg.myclass.hs2);
assert(isequal(hs2(), mypkg.myclass.s2));
assert(isequal(hs2(mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs2(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hs2(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs2(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hs2v(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hs2v(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs2v(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));

% hs2o, hs2o->s, hs2o->p, hs2o->p->s, hs2o->p->s2
hs2o = obj.call(mypkg.myclass.hs2o);
assert(isequal(hs2o(), mypkg.myclass.s2));
assert(isequal(hs2o(mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs2o(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hs2o(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs2o(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hs2vo(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hs2vo(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hs2vo(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hl(mypkg.myclass.s2), mypkg.myclass.s2));
assert(isequal(hl(mypkg.myclass.p), mypkg.myclass.p));
assert(isequal(hl(mypkg.myclass.p, mypkg.myclass.s), mypkg.myclass.s));
assert(isequal(hl(mypkg.myclass.p, mypkg.myclass.s2), mypkg.myclass.s2));
...
assert(isequal(hp(mypkg.myclass.s2), mypkg.myclass.s2));
